            ...
            <div className="flex overflow-x-auto scrollbar-none snap-x w-full justify-evenly" style={{ WebkitOverflowScrolling: "touch" }}>
              ...
              {showMissions && !showOnboardingEntry && !showUpgradeEntry && !isDemo && (
                <button
                  ...
                  className="my-auto ml-2 mr-1 flex-shrink-0 w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold transition-all hover:scale-105 active:scale-95"
                  style={{
