      ...
      if (allMissionsForPlanDone(career.id, "free")) {
        ...
        if (!localStorage.getItem(freeGuardKey)) {
          ...
          const welcomePost: NewsPost = {
            ...
            content: `Bem-vindo ao FC Career Manager!\n\nVocê completou as missões de boas-vindas e desbloqueou o app completo. Aqui começa a sua jornada como treinador — cada decisão importa, cada temporada escreve a sua história.\n\nO que você pode fazer agora:\n• Converse com o presidente e os membros da diretoria do ${career.clubName} na aba Diretoria\n• Gere notícias com IA sobre a sua carreira e o clube na aba Notícias\n• Registre transferências, empréstimos e renovações na aba Elenco\n• Documente momentos especiais com fotos e vídeos na aba Álbum\n• Acompanhe as partidas e resultados na aba Jogos\n\nO presidente do ${career.clubName} já está na sua diretoria aguardando o primeiro contato. Boa sorte, treinador — o futebol está esperando por você.`,
            likes: 0,
            commentsCount: 0,
            sharesCount: 0,
            comments: [],
