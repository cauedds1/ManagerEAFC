...
export function CoachSetup({ onNext, initial }: CoachSetupProps) {
  ...
  return (
    <div className="flex flex-col h-full animate-fade-up">
      ...
      <div className="flex flex-col gap-6 flex-1">
        <div className="flex justify-center">
          <div className="relative">
            <button
              ...
              className="relative w-24 h-24 rounded-full overflow-hidden flex items-center justify-center group transition-all duration-300"
              style={{
            ...
            {photo && (
              <button
                ...
                className="absolute -top-1 -right-1 w-6 h-6 rounded-full bg-red-500/80 flex items-center justify-center text-white hover:bg-red-400 transition-colors backdrop-blur-sm"
              >
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3.5 rounded-xl text-white placeholder-white/20 focus:outline-none transition-all duration-300 text-base glass"
        ...
        <div className="flex gap-3">
          <div className="flex-1 relative">
            ...
            <button
              ...
              className="w-full flex items-center gap-3 px-4 py-3.5 rounded-xl text-left transition-all duration-300 glass glass-hover"
            >
      ...
      <button
        onClick={handleNext}
        className="w-full py-4 rounded-2xl font-bold text-white text-base transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] mt-8"
