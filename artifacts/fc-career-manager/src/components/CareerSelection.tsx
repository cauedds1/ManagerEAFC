  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute top-4 right-4 w-6 h-6 rounded-md flex items-center justify-center opacity-0 group-hover:opacity-100 hover:!opacity-100 text-white/0 group-hover:text-white/30 hover:!text-red-400 hover:!bg-red-500/15 [@media(pointer:coarse)]:opacity-30 [@media(pointer:coarse)]:text-white/30 transition-all duration-200"
