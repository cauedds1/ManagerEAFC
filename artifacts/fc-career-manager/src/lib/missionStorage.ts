...
export interface MissionDef {
  ...
  tab: string;
  rewardKey: string;
  trigger: "match_added" | "news_generated_auto" | "news_generated" | "elenco_tab_viewed" | "board_member_added" | "momento_saved" | "news_count_3" | "rumor_post_generated" | "portal_created" | "rival_added";
  teaserKey?: TeaserKey;
}
