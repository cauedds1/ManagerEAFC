...
import { generateBasePlayerId } from "@/lib/baseStorage";
...
const POSITIONS: PositionPtBr[] = ["GOL", "DEF", "DEF", "DEF", "MID", "MID", "MID", "ATA", "ATA"];

/**
 * Generate a random base player. Distribution favors mid-tier potential
 * with rare elite and rare modest profiles, keeping youth academies feeling
 * realistic.
 */
export function generateRandomBasePlayer(): BasePlayer {
  ...
  // 8% elite, 35% promissor, 57% modesto
  ...
  // Starting OVR scales with age and potential
...
/** Generate the initial seed of 8–12 base players for a fresh academy. */
