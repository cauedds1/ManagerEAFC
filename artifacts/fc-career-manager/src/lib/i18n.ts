...
export const PAINEL: Record<Lang, Record<string, string>> = {
  pt: {
    ...
    autoGoalsNote: "Gols calculados automaticamente das partidas de liga",
    leagueMatchesLabel: "partidas de liga",
  ...
  en: {
    ...
    autoGoalsNote: "Goals auto-calculated from league matches",
    leagueMatchesLabel: "league matches",
...
export const WIZARD = {
  pt: {
    ...
    // Career type selection (pre-step)
    careerTypeTitle: "Tipo de Carreira",
    careerTypeSubtitle: "Como você quer começar sua carreira?",
    careerTypeNew: "Carreira Nova",
    careerTypeNewDesc: "Comece do zero — configure tudo do início, com torcida e diretoria neutras.",
    careerTypeOngoing: "Carreira em Andamento",
    careerTypeOngoingDesc: "Já tem uma carreira no EA FC? Descreva onde está e a IA vai carregar o contexto para você.",
    // Ongoing career input step
    ongoingTitle: "Sua Carreira Atual",
    ongoingSubtitle: "Descreva sua situação atual no EA FC — temporada, posição na tabela, humor da torcida, resultados recentes, objetivos, o que quiser. Pode ser em qualquer idioma.",
    ongoingPlaceholder: "Ex: Estou no Chelsea na temporada 2024/25, na 3ª posição da Premier League, com 8 vitórias seguidas. A torcida está eufórica e a diretoria pediu o título. Eliminei o City na Copa da Liga...",
    ongoingAnalyze: "Analisar com IA",
    ongoingAnalyzing: "Analisando...",
    ongoingError: "Não foi possível analisar. Tente novamente.",
    ongoingSkip: "Pular esta etapa",
    ongoingBack: "Voltar",
    // AI parsed context preview
    previewTitle: "Contexto Extraído pela IA",
    previewSubtitle: "Revise os valores extraídos. Você pode continuar ou editar antes de iniciar.",
    previewBoardMood: "Humor da Diretoria",
    previewFanMood: "Humor da Torcida",
    previewSeason: "Temporada",
    previewProject: "Objetivo Sugerido",
    previewNarrative: "Resumo da Carreira",
    previewConfidence: "Confiança",
    previewConfidenceLow: "Baixa — pode revisar",
    previewConfidenceMedium: "Média",
    previewConfidenceHigh: "Alta",
    previewContinue: "Parece bom — continuar",
    previewEdit: "Editar descrição",
    // Rich ongoing-context preview
    pathQuick: "Rápido",
    pathQuickDesc: "Só conte em uma frase onde você está. Sem detalhes.",
    pathDetailed: "Detalhado",
    pathDetailedDesc: "Conte tudo: clube, técnico, temporada, posição, humor, transferências, jogadores-chave, narrativa. Quanto mais, melhor.",
    pathManual: "Manual",
    pathManualDesc: "Eu prefiro configurar tudo na mão, sem IA.",
    fieldsCaptured: "campos capturados — edite o que precisar abaixo",
    templatesLabel: "Modelos rápidos",
    tplStart: "Comecei agora — pré-temporada",
    tplMid: "No meio da temporada",
    tplEnd: "Reta final, brigando por algo grande",
    tplTitle: "Brigando pelo título",
    tplRel: "Lutando contra o rebaixamento",
    tplRebuild: "Reconstrução de longo prazo",
    analyzeAgain: "Analisar de novo",
    extractedClub: "Clube identificado",
    extractedClubMissing: "Clube não identificado — escolha manualmente",
    extractedSeasonStage: "Fase da temporada",
    extractedPosition: "Posição na liga",
    extractedForm: "Forma recente",
    extractedKeyPlayers: "Jogadores-chave",
    extractedTransfersIn: "Reforços",
    extractedTransfersOut: "Saídas",
    extractedRivals: "Rivais",
    extractedRecentMatches: "Últimos jogos",
    extractedStoryArc: "Arco da história",
    extractedFinances: "Finanças",
    extractedDressingRoom: "Vestiário",
    extractedMissions: "Missões iniciais",
    boardLetterTitle: "Carta da Diretoria",
    predictionTitle: "Previsão da IA",
    predEndOfSeason: "Fim da temporada",
    predBoardReaction: "Reação da diretoria",
    inconsistenciesTitle: "Possíveis inconsistências",
    deepenTitle: "Quer enriquecer ainda mais?",
    deepenHint: "Responda alguma destas perguntas no campo de descrição e analise de novo.",
    squadSyncTitle: "Atenção ao elenco real do EA FC",
    squadSyncFallback: "O elenco real do seu EA FC pode diferir do que a IA extraiu. Verifique os jogadores em jogo antes de tomar decisões importantes.",
    appliedToTabs: "Aplicado às abas",
    appliedToTabsTooltip: "Reforços, saídas, últimos jogos e rivais já foram cadastrados nas abas Transferências, Partidas e Rivais.",
    confidenceLow: "baixa",
    confidenceMedium: "média",
    confidenceHigh: "alta",
    confLabel: "confiança",
    selectClubManually: "Escolher clube manualmente",
    autoFilledFromAI: "Preenchido pela IA",
    rolesStar: "Estrela",
    rolesCaptain: "Capitão",
    rolesYoung: "Jovem promessa",
    rolesLoan: "Empréstimo",
    rolesInjured: "Lesionado",
    seasonStageEarly: "Início",
    seasonStageMid: "Meio",
    seasonStageLate: "Final",
    seasonStagePre: "Pré-temporada",
    seasonStagePlayoffs: "Playoffs",
    seasonStageFinished: "Finalizada",
    matchdayLabel: "Rodada",
  },
  en: {
    stepCoach: "Coach",
    stepClub: "Club",
    ...
    // Career type selection (pre-step)
    careerTypeTitle: "Career Type",
    careerTypeSubtitle: "How do you want to start your career?",
    careerTypeNew: "New Career",
    careerTypeNewDesc: "Start from scratch — set everything up fresh, with neutral fan and board mood.",
    careerTypeOngoing: "Ongoing Career",
    careerTypeOngoingDesc: "Already playing a career in EA FC? Describe where you are and the AI will load the context for you.",
    // Ongoing career input step
    ongoingTitle: "Your Current Career",
    ongoingSubtitle: "Describe your current situation in EA FC — season, league position, fan mood, recent results, objectives, anything. Any language works.",
    ongoingPlaceholder: "E.g.: I'm managing Chelsea in the 2024/25 season, sitting 3rd in the Premier League after 8 straight wins. Fans are euphoric and the board wants the title. I knocked out Man City in the League Cup...",
    ongoingAnalyze: "Analyse with AI",
    ongoingAnalyzing: "Analysing...",
    ongoingError: "Could not analyse. Please try again.",
    ongoingSkip: "Skip this step",
    ongoingBack: "Back",
    // AI parsed context preview
    previewTitle: "AI-Extracted Context",
    previewSubtitle: "Review the extracted values. You can continue or edit before starting.",
    previewBoardMood: "Board Mood",
    previewFanMood: "Fan Mood",
    previewSeason: "Season",
    previewProject: "Suggested Objective",
    previewNarrative: "Career Summary",
    previewConfidence: "Confidence",
    previewConfidenceLow: "Low — please review",
    previewConfidenceMedium: "Medium",
    previewConfidenceHigh: "High",
    previewContinue: "Looks good — continue",
    previewEdit: "Edit description",
    // Rich ongoing-context preview
    pathQuick: "Quick",
    pathQuickDesc: "Just tell me where you are in one sentence. No details.",
    pathDetailed: "Detailed",
    pathDetailedDesc: "Tell me everything: club, coach, season, position, mood, transfers, key players, narrative. The more the better.",
    pathManual: "Manual",
    pathManualDesc: "I'd rather set everything up by hand, no AI.",
    fieldsCaptured: "fields captured — edit anything below",
    templatesLabel: "Quick templates",
    tplStart: "Just started — pre-season",
    tplMid: "Mid-season",
    tplEnd: "Final stretch, fighting for something big",
    tplTitle: "Fighting for the title",
    tplRel: "Battling relegation",
    tplRebuild: "Long-term rebuild",
    analyzeAgain: "Analyse again",
    extractedClub: "Detected club",
    extractedClubMissing: "Club not detected — pick manually",
    extractedSeasonStage: "Season stage",
    extractedPosition: "League position",
    extractedForm: "Recent form",
    extractedKeyPlayers: "Key players",
    extractedTransfersIn: "Signings",
    extractedTransfersOut: "Departures",
    extractedRivals: "Rivals",
    extractedRecentMatches: "Recent matches",
    extractedStoryArc: "Story arc",
    extractedFinances: "Finances",
    extractedDressingRoom: "Dressing room",
    extractedMissions: "Initial missions",
    boardLetterTitle: "Letter from the Board",
    predictionTitle: "AI Prediction",
    predEndOfSeason: "End of season",
    predBoardReaction: "Board reaction",
    inconsistenciesTitle: "Possible inconsistencies",
    deepenTitle: "Want to enrich it further?",
    deepenHint: "Answer any of these in the description field and analyse again.",
    squadSyncTitle: "Watch the actual EA FC squad",
    squadSyncFallback: "Your real EA FC squad may differ from what the AI extracted. Verify players in-game before making major decisions.",
    appliedToTabs: "Applied to tabs",
    appliedToTabsTooltip: "Signings, departures, recent matches and rivals have been pre-loaded into the Transfers, Matches and Rivals tabs.",
    confidenceLow: "low",
    confidenceMedium: "medium",
    confidenceHigh: "high",
    confLabel: "confidence",
    selectClubManually: "Pick club manually",
    autoFilledFromAI: "Filled by AI",
    rolesStar: "Star",
    rolesCaptain: "Captain",
    rolesYoung: "Young promise",
    rolesLoan: "Loan",
    rolesInjured: "Injured",
    seasonStageEarly: "Early",
    seasonStageMid: "Mid",
    seasonStageLate: "Late",
    seasonStagePre: "Pre-season",
    seasonStagePlayoffs: "Playoffs",
    seasonStageFinished: "Finished",
...
export const CLUBE = {
  pt: {
    ...
    recordsSecYear: "Ano civil",
    recBiggestWin: "Maior vitória do clube",
    recBiggestWinHome: "Maior vitória em casa",
    recBiggestWinAway: "Maior vitória fora",
    recBiggestLoss: "Maior derrota do clube",
    recBiggestLossHome: "Maior derrota em casa",
    recBiggestLossAway: "Maior derrota fora",
    recHighestDraw: "Empate com mais gols",
    recMostGoalsFor: "Mais gols da equipe em uma partida",
    recMostGoalsAgainst: "Mais gols sofridos em uma partida",
    recMostGoalsTotal: "Mais gols em uma partida",
    recMostFaced: "Adversário mais enfrentado",
    recMostScoredVs: "Mais gols contra um clube",
    recMostConcededVs: "Mais gols sofridos contra um clube",
    recMostBeaten: "Adversário mais vencido",
    recHardest: "Adversário mais difícil",
    recSeasonMostGoals: "Mais gols em uma temporada",
    recSeasonMostMatches: "Mais partidas em uma temporada",
    recSeasonMostWins: "Mais vitórias em uma temporada",
    recSeasonMostDraws: "Mais empates em uma temporada",
    recSeasonMostLosses: "Mais derrotas em uma temporada",
    recSeasonMostCleanSheets: "Mais clean sheets em uma temporada",
    recSeasonBestAvg: "Maior média de gols por jogo",
    recYearMostGoals: "Mais gols em um ano civil",
    recYearMostWins: "Mais vitórias em um ano civil",
    recYearMostDraws: "Mais empates em um ano civil",
    recYearMostLosses: "Mais derrotas em um ano civil",
    recStreakWins: "Mais vitórias seguidas",
    recStreakUnbeaten: "Mais jogos sem perder",
    recStreakCleanSheet: "Mais clean sheets seguidos",
    recordsSecPlayers: "Jogadores",
    recPlayerTopScorer: "Artilheiro histórico",
    recPlayerTopAssists: "Mais assistências",
    recPlayerMostMotm: "Mais Man of the Match",
    recPlayerMostMatches: "Mais jogos disputados",
    recPlayerBestRating: "Melhor média de nota",
    recPlayerMinMatches: "mín. {n} jogos",
    // FinanceiroView
  ...
  en: {
    ...
    recordsSecYear: "Calendar year",
    recBiggestWin: "Biggest club win",
    recBiggestWinHome: "Biggest home win",
    recBiggestWinAway: "Biggest away win",
    recBiggestLoss: "Biggest club loss",
    recBiggestLossHome: "Biggest home loss",
    recBiggestLossAway: "Biggest away loss",
    recHighestDraw: "Highest-scoring draw",
    recMostGoalsFor: "Most goals scored in a match",
    recMostGoalsAgainst: "Most goals conceded in a match",
    recMostGoalsTotal: "Most goals in a match (total)",
    recMostFaced: "Most-faced opponent",
    recMostScoredVs: "Most goals against one club",
    recMostConcededVs: "Most goals conceded to one club",
    recMostBeaten: "Most-beaten opponent",
    recHardest: "Toughest opponent",
    recSeasonMostGoals: "Most goals in a season",
    recSeasonMostMatches: "Most matches in a season",
    recSeasonMostWins: "Most wins in a season",
    recSeasonMostDraws: "Most draws in a season",
    recSeasonMostLosses: "Most losses in a season",
    recSeasonMostCleanSheets: "Most clean sheets in a season",
    recSeasonBestAvg: "Best goals-per-match average",
    recYearMostGoals: "Most goals in a calendar year",
    recYearMostWins: "Most wins in a calendar year",
    recYearMostDraws: "Most draws in a calendar year",
    recYearMostLosses: "Most losses in a calendar year",
    recStreakWins: "Longest winning streak",
    recStreakUnbeaten: "Longest unbeaten run",
    recStreakCleanSheet: "Longest clean sheet run",
    recordsSecPlayers: "Players",
    recPlayerTopScorer: "All-time top scorer",
    recPlayerTopAssists: "Most assists",
    recPlayerMostMotm: "Most Man of the Match",
    recPlayerMostMatches: "Most matches played",
    recPlayerBestRating: "Best average rating",
    recPlayerMinMatches: "min. {n} matches",
    // FinanceiroView
...
export const TRANSFERENCIAS: Record<Lang, Record<string, string>> = {
  pt: {
    ...
    windowActivatedSingular: "jogador adicionado ao elenco",
    windowActivatedPlural: "jogadores adicionados ao elenco",
    ...
    // Transfer date
    transferDateLabel: "Data da negociação",
    transferDatePlaceholder: "Opcional",
    // Transfer card badges
    badgeVenda: "VENDA",
    badgeEmprestimo: "EMPRÉSTIMO",
    badgePendente: "PENDENTE",
    badgeEntraJanela: "Entra na próxima janela",
    badgeSaiJanela: "Sai na próxima janela",
    badgeLoanIn: "↓ Entrada",
    badgeLoanOut: "↑ Saída",
    ...
    phPhoto: "https://...",
    // Edit transfer modal
    editModalTitle: "Editar Transferência",
    editModalPlayer: "Jogador",
    editModalPlayerInfo: "Dados do jogador",
    playerNameLabel: "Nome do jogador",
    playerPhotoLabel: "URL da foto",
    playerPhotoPlaceholder: "https://...",
    editModalFinancial: "Valores financeiros",
    editModalClubs: "Clubes",
    editModalSave: "Salvar Alterações",
    editModalClose: "Fechar",
    editModalCancelTransfer: "Cancelar Transferência",
    editModalCancelConfirm: "Tem certeza? Essa ação reverterá o elenco.",
    editModalCancelYes: "Sim, cancelar",
    editModalCancelBack: "Voltar",
    editCancelCompraHint: "O jogador será removido do elenco.",
    editCancelVendaHint: "O jogador retornará ao elenco.",
    editCancelEmprestimoHint: "O empréstimo será removido.",
    // Abbreviations
    contractYearAbbr: "A",
    overallAbbr: "OVR",
  },
  en: {
    ...
    windowActivatedSingular: "player added to squad",
    windowActivatedPlural: "players added to squad",
    ...
    // Transfer date
    transferDateLabel: "Deal date",
    transferDatePlaceholder: "Optional",
    // Transfer card badges
    badgeVenda: "SALE",
    badgeEmprestimo: "LOAN",
    badgePendente: "PENDING",
    badgeEntraJanela: "Joins on next window",
    badgeSaiJanela: "Leaves on next window",
    badgeLoanIn: "↓ In",
    badgeLoanOut: "↑ Out",
    ...
    phPhoto: "https://...",
    // Edit transfer modal
    editModalTitle: "Edit Transfer",
    editModalPlayer: "Player",
    editModalPlayerInfo: "Player info",
    playerNameLabel: "Player name",
    playerPhotoLabel: "Photo URL",
    playerPhotoPlaceholder: "https://...",
    editModalFinancial: "Financial values",
    editModalClubs: "Clubs",
    editModalSave: "Save Changes",
    editModalClose: "Close",
    editModalCancelTransfer: "Cancel Transfer",
    editModalCancelConfirm: "Are you sure? This will revert the squad.",
    editModalCancelYes: "Yes, cancel",
    editModalCancelBack: "Go back",
    editCancelCompraHint: "The player will be removed from the squad.",
    editCancelVendaHint: "The player will return to the squad.",
    editCancelEmprestimoHint: "The loan will be removed.",
    // Abbreviations
    contractYearAbbr: "Y",
    overallAbbr: "OVR",
  },
...
export const PARTIDAS: Record<Lang, Record<string, string>> = {
  pt: {
    ...
    removeTitle: "Remover",
    swapTitle: "Trocar",
    swapWaiting: "Aguardando...",
    swapTooltip: "Trocar / Substituir",
    swapHowQuestion: "Como foi essa movimentação?",
    swapRotation: "🔄 Rotação (pré-jogo)",
    swapSubstitution: "↩ Substituição",
    cancelLabel: "Cancelar",
    benchLabel: "Banco",
    noRelated: "Sem relacionados no elenco",
    viewCampinho: "Ver campinho",
    viewLista: "Ver lista",
  ...
  en: {
    ...
    swapTitle: "Swap",
    swapWaiting: "Waiting...",
    swapTooltip: "Swap / Substitute",
    swapHowQuestion: "How was this movement?",
    swapRotation: "🔄 Rotation (pre-match)",
    swapSubstitution: "↩ Substitution",
    cancelLabel: "Cancel",
    benchLabel: "Bench",
    noRelated: "No squad members added",
    viewCampinho: "View pitch",
    viewLista: "View list",
    // PlayerLineupRow & sub-components
    ratingLabel: "Rating",
    goalsSection: "Goals",
...
export const DASHBOARD: Record<Lang, Record<string, string>> = {
  pt: {
    ...
    boardMoodTooltip: "Humor da diretoria: {label} ({score}/100)",
    boardMoodLabel: "Diretoria",
    fanMoodLabel: "Torcida",
  ...
  en: {
    ...
    boardMoodTooltip: "Board mood: {label} ({score}/100)",
    boardMoodLabel: "Board",
    fanMoodLabel: "Fans",
...
export const SETTINGS: Record<Lang, Record<string, string>> = {
  pt: {
    ...
    exportCareerTitle: "Exportar Carreira",
    exportCareerSubtitle: "Baixa um arquivo JSON com todos os dados desta carreira: clube, temporadas, partidas, notícias, elenco e diretoria.",
    exportCareerLabel: "Exportar carreira",
    exportCareerDesc: "Gera um arquivo JSON completo com todos os dados para backup ou para configurar a demo.",
    ...
    upgradeUltraDesc: "Com o Ultra você tem gerações ilimitadas de IA, GPT-4.1, portais personalizados e notícias automáticas.",
    planTitle: "Seu Plano",
  ...
  en: {
    ...
    exportCareerTitle: "Export Career",
    exportCareerSubtitle: "Downloads a JSON file with all data from this career: club, seasons, matches, news, squad and board.",
    exportCareerLabel: "Export career",
    exportCareerDesc: "Generates a complete JSON file with all career data for backup or demo setup.",
    ...
    upgradeUltraDesc: "With Ultra you get unlimited AI generations, GPT-4.1, custom portals and automatic news.",
    planTitle: "Your Plan",
...
export const NEW_SEASON_WIZARD: Record<Lang, Record<string, string>> = {
  pt: {
    ...
    step3Title: "Objetivos da Temporada",
    step3Desc: "Defina até 3 metas para a temporada. Falhar em objetivos afeta o humor da diretoria.",
    objTypeLeague: "Posição na Liga",
    objTypeCup: "Copa",
    objTypeCustom: "Personalizado",
    objTargetLeaguePlaceholder: "ex: Top 4, Campeão, Não Rebaixar...",
    objTargetCupPlaceholder: "ex: Semifinal, Quartas...",
    objTargetCustomPlaceholder: "Descreva o objetivo...",
    objCompetitionPlaceholder: "Competição (ex: Copa do Brasil)",
    btnAddObj: "+ Adicionar objetivo",
    btnRemoveObj: "Remover",
    objSeverityLabel: "Severidade se falhar:",
    objSeverityMinor: "Leve (-5)",
    objSeverityModerate: "Moderada (-10)",
    objSeverityMajor: "Grave (-15)",
    objSkip: "Pular por agora",
  },
  en: {
    ...
    step3Title: "Season Objectives",
    step3Desc: "Set up to 3 goals for the season. Failing objectives affects board mood.",
    objTypeLeague: "League Position",
    objTypeCup: "Cup",
    objTypeCustom: "Custom",
    objTargetLeaguePlaceholder: "e.g. Top 4, Champions, Avoid Relegation...",
    objTargetCupPlaceholder: "e.g. Semi-final, Quarters...",
    objTargetCustomPlaceholder: "Describe the objective...",
    objCompetitionPlaceholder: "Competition (e.g. FA Cup)",
    btnAddObj: "+ Add objective",
    btnRemoveObj: "Remove",
    objSeverityLabel: "Severity if failed:",
    objSeverityMinor: "Minor (-5)",
    objSeverityModerate: "Moderate (-10)",
    objSeverityMajor: "Major (-15)",
    objSkip: "Skip for now",
  },
};
...
// Player Detail Panel
// ─────────────────────────────────────────────────────────────────────────────
export const PLAYER_DETAIL: Record<Lang, Record<string, string>> = {
  pt: {
    tabStats: "Estatísticas",
    tabMomentos: "Momentos",
    tabEdit: "Editar Jogador",
    statMood: "Humor",
    statFans: "Torcida",
    statAvgRating: "Nota Média",
    statMatches: "Partidas",
    statCards: "Cartões",
    statGames: "jogos",
    statNoData: "sem dados",
    statStarterAbbr: "T",
    statBenchAbbr: "B",
    statOwnGoalAbbr: "gol c.",
    statClean: "limpo",
    logSection: "Registrar",
    logGoals: "Gols",
    logAssists: "Assist.",
    logStarter: "Titular",
    logMinutes: "Minutos",
    removeTitle: "Remover do Elenco",
    removeDesc: "Remove o jogador da visualização do elenco.",
    removeConfirmDesc: "Confirma a remoção? Essa ação não pode ser desfeita.",
    btnCancel: "Cancelar",
    btnConfirm: "Confirmar",
    btnRemove: "Remover",
    editName: "Nome exibido",
    editPhoto: "Foto do jogador",
    editPhotoPlaceholder: "https://... (URL da foto)",
    editPhotoInvalid: "URL inválida ou imagem não carregou",
    editPhotoRemove: "Remover foto",
    editNumber: "Número",
    editOverall: "Overall",
    editSalary: "Sal. (k/sem)",
    editSalaryUnit: "k/sem",
    editPosition: "Posição",
    editOvrHistory: "Evolução de OVR",
    editOvrDate: "Data da mudança",
    btnCancelEdit: "Cancelar",
    btnEdit: "Editar",
    btnUpdateOvr: "Atualizar OVR ↑",
    btnSave: "Salvar Alterações",
    btnClose: "Fechar",
    ageUnit: "anos",
    momentoViewTooltip: "Ver na aba Momentos",
    noMomentsWith: "Nenhum momento com",
    dateLocale: "pt-BR",
  },
  en: {
    tabStats: "Statistics",
    ...
    removeDesc: "Remove the player from the squad view.",
    removeConfirmDesc: "Confirm removal? This action cannot be undone.",
    btnCancel: "Cancel",
    btnConfirm: "Confirm",
    btnRemove: "Remove",
    editName: "Display name",
    editPhoto: "Player photo",
    editPhotoPlaceholder: "https://... (photo URL)",
    editPhotoInvalid: "Invalid URL or image failed to load",
    editPhotoRemove: "Remove photo",
    editNumber: "Number",
    editOverall: "Overall",
    editSalary: "Wage (k/wk)",
    editSalaryUnit: "k/wk",
    editPosition: "Position",
    editOvrHistory: "OVR History",
    editOvrDate: "Change date",
    ...
    btnClose: "Close",
    ageUnit: "y.o.",
    momentoViewTooltip: "View in Moments tab",
    noMomentsWith: "No moments with",
    dateLocale: "en-GB",
  },
};
...
export const POSITION_DISPLAY: Record<Lang, Record<string, string>> = {
  pt: { GOL: "GOL", DEF: "DEF", MID: "MID", ATA: "ATA" },
  en: { GOL: "GK",  DEF: "DEF", MID: "MID", ATA: "FWD" },
};

// ─────────────────────────────────────────────────────────────────────────────
// Player Profile Modal (4 tabs)
// ─────────────────────────────────────────────────────────────────────────────
export const PLAYER_PROFILE: Record<Lang, Record<string, string>> = {
  pt: {
    tabDetails: "Detalhes",
    tabSeason: "Temporada",
    tabMatches: "Partidas",
    tabCareer: "Carreira",
    fullProfileBtn: "Dados Completos",
    nationality: "Nacionalidade",
    age: "Idade",
    position: "Posição",
    height: "Altura",
    ...
    contractStart: "Início",
    contractEnd: "Fim",
    ovrSection: "Overall",
    salarySection: "Histórico de Salário",
    marketValueSection: "Valor de Mercado",
    seasonSection: "Temporada",
    matchesBlock: "Partidas",
    attackBlock: "Ataque",
    passesBlock: "Passes",
    defenseBlock: "Defesa",
    otherBlock: "Outro",
    ...
    minutes: "Minutos",
    goals: "Gols",
    penGoals: "Gols de pênalti",
    goalsPerGame: "Gols por jogo",
    hatTricks: "Hat-tricks",
    minPerGoal: "Min. por gol",
    assists: "Assistências",
    assistsPerGame: "Assist. por jogo",
    minPerAssist: "Min. por assist.",
    yellowCards: "Cartões amarelos",
    redCards: "Cartões vermelhos",
    ownGoals: "Gols contra",
    missedPenalties: "Pênaltis perdidos",
    avgRating: "Nota média",
    careerSection: "Carreira",
    seasonCol: "Temporada",
    gamesCol: "J",
    goalsCol: "GLS",
    assistsCol: "AST",
    ...
    saveBtn: "Salvar",
    cancelBtn: "Cancelar",
    newMarketValue: "Novo valor de mercado",
    valueDate: "Data",
    weekly: "/sem",
    annual: "/ano",
    passes: "Passes",
    ...
    dribbles: "Dribles",
    ballRecoveries: "Recuperações",
    ballLosses: "Perdas",
    monthlyRating: "Nota média por mês",
    ratingByMatch: "Nota por partida",
    opponent: "Adversário",
    result: "Resultado",
    rating: "Nota",
    appearance: "Entrada",
  ...
  en: {
    ...
    contractEnd: "End",
    ovrSection: "Overall",
    salarySection: "Salary History",
    marketValueSection: "Market Value",
    seasonSection: "Season",
    matchesBlock: "Matches",
    attackBlock: "Attack",
    passesBlock: "Passing",
    defenseBlock: "Defense",
    otherBlock: "Other",
    totalGames: "Games",
    starters: "Starters",
    motm: "MOTM",
    ...
    saveBtn: "Save",
    cancelBtn: "Cancel",
    newMarketValue: "New market value",
    valueDate: "Date",
    weekly: "/wk",
    annual: "/yr",
    passes: "Passes",
    ...
    monthlyRating: "Avg rating by month",
    ratingByMatch: "Rating by match",
    opponent: "Opponent",
    result: "Result",
    rating: "Rating",
...
// ─────────────────────────────────────────────────────────────────────────────
// Base (Youth Academy) tab
// ─────────────────────────────────────────────────────────────────────────────
export const BASE: Record<Lang, Record<string, string>> = {
  pt: {
    tabBase: "Base",
    heading: "Base — Categorias de base",
    subtitle: "Cadastre, acompanhe e promova as joias da casa",
    addBtn: "Adicionar à base",
    promoteBtn: "Promover",
    releaseTooltip: "Dispensar da base",
    confirmPromote: "Promover {name} para o time principal? O selo de Cria do Clube será permanente.",
    confirmRelease: "Dispensar {name} da base?",
    readyBadge: "PRONTO",
    readyTooltip: "Pronto pra promover (idade ≥ 18 ou OVR próximo do potencial)",
    yrs: "anos",
    emptyTitle: "Sua base está vazia",
    emptyDesc: "Adicione juvenis pra revelar a próxima geração — a notícia rola sozinha quando você promove.",
    addTitle: "Adicionar à base",
    addSubtitle: "Cadastre um juvenil (15–19 anos) com potencial estimado",
    firstName: "Nome",
    lastName: "Sobrenome",
    position: "Posição",
    nationality: "Nacionalidade",
    age: "Idade",
    potential: "Potencial (min–max)",
    photo: "Foto (URL)",
    optional: "opcional",
    cancel: "Cancelar",
    save: "Cadastrar",
    errName: "Informe nome e sobrenome.",
    errNat: "Informe a nacionalidade.",
    errAge: "Idade deve estar entre 15 e 19.",
    errOvr: "OVR deve estar entre 30 e 99.",
  ...
  en: {
    tabBase: "Academy",
    heading: "Academy — Youth squad",
    subtitle: "Register, develop and promote your homegrown gems",
    addBtn: "Add to academy",
    promoteBtn: "Promote",
    releaseTooltip: "Release from academy",
    confirmPromote: "Promote {name} to the first team? The Academy Product badge will be permanent.",
    confirmRelease: "Release {name} from the academy?",
    readyBadge: "READY",
    readyTooltip: "Ready to promote (age ≥ 18 or OVR close to potential)",
    yrs: "yrs",
    emptyTitle: "Your academy is empty",
    emptyDesc: "Register youngsters to develop the next generation — news fires automatically on promotion.",
    addTitle: "Add to academy",
    addSubtitle: "Register a youngster (15–19 years old) with an estimated potential",
    firstName: "First name",
    lastName: "Last name",
    position: "Position",
    nationality: "Nationality",
    age: "Age",
    potential: "Potential (min–max)",
    photo: "Photo (URL)",
    optional: "optional",
    cancel: "Cancel",
    save: "Register",
    errName: "Provide first and last name.",
    errNat: "Provide a nationality.",
    errAge: "Age must be between 15 and 19.",
    errOvr: "OVR must be between 30 and 99.",
