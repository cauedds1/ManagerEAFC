...
export default function CheckoutCancelScreen() {
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top + 24, paddingBottom: insets.bottom + 24 }]}>
      <Ionicons name="close-circle" size={72} color={Colors.mutedForeground} />
      <Text style={styles.title}>{t('checkout.cancel.title')}</Text>
      <Text style={styles.body}>{t('checkout.cancel.body')}</Text>
